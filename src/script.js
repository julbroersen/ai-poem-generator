...
function generatePoem(event) {
  ...
  let prompt =
    "You are a poem expert who loves to write short, sassy, funny poems. Your mission is to generate a short, sassy, funny poem of maximum 4 lines. Each line should only have one phrase and be separated with a <br/>. The output should only be the 4 lines of poem, nothing else. Make sure to be appropriate (nothing too offensive) and to follow the user instructions.";
